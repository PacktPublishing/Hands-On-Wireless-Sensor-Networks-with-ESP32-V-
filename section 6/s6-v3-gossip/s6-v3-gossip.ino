...
//struct Neighbours allNodesNeighboursList[] = { "a",  { "b", "c", "d", "e", "f" },
//                                               "b",  { "a", "c", "d", "e", "f" },
//                                               "c",  { "a", "b", "d", "e", "f" },
//                                               "d",  { "a", "b", "c", "e", "f" },
//                                               "e",  { "a", "b", "c", "d", "f" },
...
struct Neighbours allNodesNeighboursList[] = { "a",  { "b" },
                                               "b",  { "a", "c" },
                                               "c",  { "b", "d" },
                                               "d",  { "c", "e" },
                                               "e",  { "d", "f" },
...
int nextTrigger = 0;              // next iteration of 
...
void loop() {
  ...
  ///////////////////////////////////////////////////////////////
  if ((nextTriggerCounter == nextTrigger) && (activeMode==false)) {
      String msgToSend = createShortMsg("req", "pair");
      reqNodeName = getRandomNeighbor();
      Serial.println("Sending pair request to node " + reqNodeName);
      //pout("Pair req to " + reqNodeName);
      sendMessage(getNodeIdByName(reqNodeName), msgToSend);
      activeMode = true;         // gone in active mode
  ...
  /////////////////////////////////////////////////////////////// 
  if (activeMode == true){   //active mode timer
    currentTime = millis();
  ...
  // AFTER EVERY iteration_time, do nextTriggerCounter++
  /////////////////////////////////////////////////////////////// 
  unsigned long currentMillis = millis();
  if (currentMillis - previousMillis >= iteration_time) {
      previousMillis = currentMillis;
      nextTriggerCounter += 1;
  }
